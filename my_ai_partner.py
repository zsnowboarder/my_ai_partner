...
with col20:
    #if button is clicked
    if st.button("PD Goals", help="Create goals based on user input text"):
        placeholder = st.empty()
        placeholder.write("I am thinking...")
...
if len(result) > 10:
    warning_msg = "Generated by " + selected_model + "<br><br>Please review carefully and make neccessary edits. DO NOT copy and paste.<br><br>"
    
st.markdown(warning_msg + result, unsafe_allow_html=True)
